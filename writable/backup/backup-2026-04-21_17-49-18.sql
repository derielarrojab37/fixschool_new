...
CREATE TABLE `pengaduan` (
  ...
  `kategori` enum('ringan','berat') DEFAULT NULL,
  `status_sla` enum('aman','hampir','terlambat') DEFAULT 'aman',
...
INSERT INTO `pengaduan` VALUES (1,2,2,'Kursi Bosok','Tos rareyod korsi teh geus wayahna di omean, jelema nu ngadiukan na oge teu nyaman otomatis ngaganggu kana aktipitas, cik omean nya!','Kelas XII','1775974786_3174912535d45e01f890.jpg','selesai','2026-04-12','0',NULL,NULL,'aman'),(2,2,4,'Kursi Bosok','Tos rareyod korsi teh geus wayahna di omean, jelema nu ngadiukan na oge teu nyaman otomatis ngaganggu kana aktipitas, cik omean nya!','Kelas XII','1775975215_62c6fbae15783e76a415.jpg','ditolak','2026-04-12','apalah',NULL,NULL,'aman'),(3,2,2,'AC Lab butut','bocor wae, lantainya jadi bau kaki ','Lab Komputer SMK','1776219253_3832e7e37da48f81973b.jpg','selesai','2026-04-15','0',NULL,NULL,'aman'),(6,2,4,'tes','2323214124123213','tes XII','1776313206_6e8ec55e485f2dbf5672.jpg','ditolak','2026-04-16','aya aya wae',NULL,NULL,'aman'),(8,4,3,'Hape Butut','hape urang ruksak mang, pang benerankeun atuh','Kediaman cecep','1776492624_f564f1c1eee60eb65273.jpg','ditolak','2026-04-18','koplok teh, pan geus puguh ngaran aplikasi na oge fix school, lain repair hp plok sateh',NULL,NULL,'aman'),(10,4,2,'Layar Monitor PC 4','P Layarnya agak ada glitch mengganggu, dan terkadang layar mati lalu hidup kembali dan itu sangat mengganggu terutama disaat pengerjaan aplikasi','Lab Komputer SMK','1776533605_396da756b0afad0f90ee.jpg','diproses',NULL,'',NULL,NULL,'aman'),(11,4,2,'Paqih','aman sih','Kediaman paqih','1776667911_f98c868e2e9b35e8d7e7.jpg','diproses',NULL,'',NULL,NULL,'aman'),(13,4,2,'Dinding kotor','tolong dicat kembali','Kelas XII','1776700397_662f7d20b6c4fbc7c2b8.png','selesai',NULL,'',NULL,NULL,'aman'),(14,4,2,'Info','hayang nyapa admin weeee','Kediaman paqih',NULL,'ditolak',NULL,'tong sok minuhan tabel plok',NULL,NULL,'aman'),(15,4,2,'AC di lab gak kerasa dingin','intinya sering bocor dan tidak kerasa suhunya','Lab Komputer','1776785396_1fca2a28e14a83abe1ae.jpg','menunggu',NULL,'',NULL,NULL,'aman');
...
-- Dump completed on 2026-04-22  0:49:18
